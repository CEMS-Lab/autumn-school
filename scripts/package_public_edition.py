...
def candidate_manifest(root, version=None):
    ...
    manifest.update(
        ...
        change_scope='Six locally executed classroom notebooks with worked solutions; connected PhAST geometry-to-results practical; reviewed web HTML and native animated teaching slides',
        runtime_scope='Current local execution receipts cover six classroom notebooks after setup. Older retained HPC inverse receipts preserve their original dates and scope. Fresh authenticated Colab rehearsal remains a separate delivery gate.',
