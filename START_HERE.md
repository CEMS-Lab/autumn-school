...
- a practice notebook with tutorial code, outputs and exercise questions;
- the same notebook with hints and step-by-step worked answers.

Both run in the course environment. The website itself is a static publication,
not a Python execution service. Read **SETUP.md** before executing notebooks.
...
are original course material. External references are linked, not reproduced.
