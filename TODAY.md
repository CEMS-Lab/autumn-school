...
| [#5](https://github.com/CEMS-Lab/autumn-school/issues/5) | The connected input-to-result workflow and changed-load comparison pass locally in 92.00 s. Rehearse the published notebook in Colab; external physical-group mesh import and a validated short propagating crack retain separate acceptance checks. |
...
| [#11](https://github.com/CEMS-Lab/autumn-school/issues/11) | Timetable removal and local desktop/mobile, math, download, answer-control and offline checks pass. Verify the deployed pages and updated credits. The printable-book requirement is superseded. |
...
| [#16](https://github.com/CEMS-Lab/autumn-school/issues/16) | Publication is authorised. Verify the pushed revision, Pages deployment, credits and downloadable files; retain original-content licence and final release checks. |
...
The reviewed local candidate contains the following completed work:
...
See [today's delivery evidence](evidence/course_delivery_20260910.md) for commands, scope and remaining gates. Local execution, fresh installation and fresh Colab execution remain separate evidence. Whole issues remain open until all their acceptance checks pass. Publication is authorised; record deployment verification before marking the live-site check complete.

## Next delivery checks

- [ ] Publish the approved revision and verify the Pages deployment, prepared-by book credits, local assets and notebook downloads from the live site.
...
- [ ] Verified published revision for authenticated Colab rehearsal.
